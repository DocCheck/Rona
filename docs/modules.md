...
Additionally, you need to have the proper code running on the RaspberryPi. Check out how to configure the RaspberryPi in the [one-time configuration tutorial](config.md) 
...
To clone and prepare the repository for use with Rona follow the [quick start guide](quickstart.md)
